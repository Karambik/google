...
<body>
	<?php 
		...
		$q = mysqli_query($con, "SELECT * FROM videos INNER JOIN users ON videos.userID = users.id WHERE users.id = '{$_GET['lol']}'");
			...
			<div class="col-2">
				<div class="row">
					...
					<div class="col-2 px-0">
						<!--аккаунт-->
						<a href="account.php?id=<?php echo $_GET['lol'] ?>"><img class="w-100" src="img/7.jpg"></a>    
					</div>
				</div>
			</div>
		</div>
				...
				<div class="row">
					...
					<div class="col-3"> <!--ВИДЕО -->
						<div class="embed-responsive embed-responsive-16by9 mb-3">
							<iframe class="embed-responsive-item" src="	<?php echo $stroka['sourse'] ?>" fram="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
						</div>
						<div class="row">
							...
							<div class="col-9">							
								...
								<a href=""><p class="font-weight-bold mb-0"><?php echo $stroka['channelname']; ?></p></a>	
